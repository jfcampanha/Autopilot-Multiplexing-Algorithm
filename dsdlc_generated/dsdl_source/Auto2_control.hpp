 ...
 *
 * Source file: /home/joao/PESTA/control_system/v3/dsdl_source/Auto2_control.uavcan
 */

#ifndef DSDL_SOURCE_AUTO2_CONTROL_HPP_INCLUDED
#define DSDL_SOURCE_AUTO2_CONTROL_HPP_INCLUDED
...
template <int _tmpl>
struct UAVCAN_EXPORT Auto2_control_
{
    typedef const Auto2_control_<_tmpl>& ParameterType;
    typedef Auto2_control_<_tmpl>& ReferenceType;
    ...
    {
        return "dsdl_source.Auto2_control";
    }
...
template <int _tmpl>
bool Auto2_control_<_tmpl>::operator==(ParameterType rhs) const
{
    return
        WORKING == rhs.WORKING &&
        ALERT == rhs.ALERT &&
...
template <int _tmpl>
bool Auto2_control_<_tmpl>::isClose(ParameterType rhs) const
{
    return
...
template <int _tmpl>
int Auto2_control_<_tmpl>::encode(ParameterType self, ::uavcan::ScalarCodec& codec,
...
template <int _tmpl>
int Auto2_control_<_tmpl>::decode(ReferenceType self, ::uavcan::ScalarCodec& codec,
    ::uavcan::TailArrayOptimizationMode tao_mode)
{
    (void)self;
    (void)codec;
 ...
 */
template <int _tmpl>
::uavcan::DataTypeSignature Auto2_control_<_tmpl>::getDataTypeSignature()
{
    ::uavcan::DataTypeSignature signature(0x1A1B01264D968B8BULL);
 ...
 * Final typedef
 */
typedef Auto2_control_<0> Auto2_control;
...
template <>
class UAVCAN_EXPORT YamlStreamer< ::dsdl_source::Auto2_control >
{
public:
    template <typename Stream>
    static void stream(Stream& s, ::dsdl_source::Auto2_control::ParameterType obj, const int level);
};

template <typename Stream>
void YamlStreamer< ::dsdl_source::Auto2_control >::stream(Stream& s, ::dsdl_source::Auto2_control::ParameterType obj, const int level)
{
    (void)s;
    (void)obj;
    (void)level;
    ...
    s << "WORKING: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::WORKING >::stream(s, obj.WORKING, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "ALERT: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::ALERT >::stream(s, obj.ALERT, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "FAILURE: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::FAILURE >::stream(s, obj.FAILURE, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "UNTRUSTED: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::UNTRUSTED >::stream(s, obj.UNTRUSTED, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "CHECKCONTROL_ACC: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::CHECKCONTROL_ACC >::stream(s, obj.CHECKCONTROL_ACC, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "CHECKCONTROL_AIR: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::CHECKCONTROL_AIR >::stream(s, obj.CHECKCONTROL_AIR, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "CHECKCONTROL_BARO: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::CHECKCONTROL_BARO >::stream(s, obj.CHECKCONTROL_BARO, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "CHECKCONTROL_GYRO: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::CHECKCONTROL_GYRO >::stream(s, obj.CHECKCONTROL_GYRO, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "CHECKCONTROL_MAG: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::CHECKCONTROL_MAG >::stream(s, obj.CHECKCONTROL_MAG, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "CHECKCONTROL_GNSS: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::CHECKCONTROL_GNSS >::stream(s, obj.CHECKCONTROL_GNSS, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "UNTRUSTED_ACC: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::UNTRUSTED_ACC >::stream(s, obj.UNTRUSTED_ACC, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "UNTRUSTED_AIR: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::UNTRUSTED_AIR >::stream(s, obj.UNTRUSTED_AIR, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "UNTRUSTED_BARO: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::UNTRUSTED_BARO >::stream(s, obj.UNTRUSTED_BARO, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "UNTRUSTED_GYRO: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::UNTRUSTED_GYRO >::stream(s, obj.UNTRUSTED_GYRO, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "UNTRUSTED_MAG: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::UNTRUSTED_MAG >::stream(s, obj.UNTRUSTED_MAG, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "UNTRUSTED_GNSS: ";
    YamlStreamer< ::dsdl_source::Auto2_control::FieldTypes::UNTRUSTED_GNSS >::stream(s, obj.UNTRUSTED_GNSS, level + 1);
}
...
template <typename Stream>
inline Stream& operator<<(Stream& s, ::dsdl_source::Auto2_control::ParameterType obj)
{
    ::uavcan::YamlStreamer< ::dsdl_source::Auto2_control >::stream(s, obj, 0);
    return s;
}

} // Namespace dsdl_source

#endif // DSDL_SOURCE_AUTO2_CONTROL_HPP_INCLUDED